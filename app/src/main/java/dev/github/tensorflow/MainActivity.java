...
import dev.github.tensorflow.images.ImageClassifier;
import dev.github.tensorflow.images.ImageHelper;
import dev.github.tensorflow.images.Recognition;
import dev.github.tensorflow.views.CameraPreviewFragment;
...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button voice_button= (Button) findViewById(R.id.voice_button);
        voice_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "ခုမရႏုိင္ေသးပါ", Toast.LENGTH_LONG).show();
            }
        });
